...
namespace Danciu_Lavinia_Lab5
{
    public partial class MLModel
    {
        public const string RetrainFilePath =  @"C:\Users\lavi_\Downloads\RESTAURANTSCORES.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"InspectionType",outputColumnName:@"InspectionType")      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.LightGbm(new LightGbmMulticlassTrainer.Options(){NumberOfLeaves=4,NumberOfIterations=3019,MinimumExampleCountPerLeaf=20,LearningRate=0.33924133010708335,LabelColumnName=@"RiskCategory",FeatureColumnName=@"Features",Booster=new GradientBooster.Options(){SubsampleFraction=0.4009080685217593,FeatureFraction=0.9819240987087096,L1Regularization=3.2329376488167465E-10,L2Regularization=0.3714717214916478},MaximumBinCountPerFeature=211}))      
